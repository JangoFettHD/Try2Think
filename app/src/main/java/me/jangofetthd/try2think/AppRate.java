...
public class AppRate implements android.content.DialogInterface.OnClickListener, OnCancelListener {
	...
	private void showDefaultDialog() {
		...
		String title = "Оцените приложение";
		String message = "Если Вам нравится приложение \"" + getApplicationName(hostActivity.getApplicationContext()) + "\", пожалуйста, уделите минутку и оцените его на 5 звезд. Спасибо!";
		String rate = "Оценить!";
		String remindLater = "Позже";
		String dismiss = "Нет, спасибо";
	...
	public void onClick(DialogInterface dialog, int which) {
		...
		case DialogInterface.BUTTON_POSITIVE:
			try
			{
				...
				Toast.makeText(hostActivity, "Play Store не установлен", Toast.LENGTH_SHORT).show();
			}
